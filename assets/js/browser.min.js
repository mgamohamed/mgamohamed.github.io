...
var browser = function () {'use strict';var t = {name: null,version: null,os: null,osVersion: null,touch: null,mobile: null,_canUse: null,canUse: function (e) {t._canUse || (t._canUse = document.createElement('div'));var n = t._canUse.style,r = e.charAt(0).toUpperCase() + e.slice(1)
  ...
  return t.init(), t}()
!function (e, n) {
  'function' == typeof define && define.amd ? define([], n) : 'object' == typeof exports ? module.exports = n() : e.browser = n()}(this, function () {return browser})
